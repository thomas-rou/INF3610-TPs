...
// ==============================================================
#ifndef __mmult_hw_mac_mulacud__HH__
#define __mmult_hw_mac_mulacud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(mmult_hw_mac_mulacud) {
    ...
    SC_CTOR(mmult_hw_mac_mulacud):  simcore_mac_1_U ("simcore_mac_1_U") {
