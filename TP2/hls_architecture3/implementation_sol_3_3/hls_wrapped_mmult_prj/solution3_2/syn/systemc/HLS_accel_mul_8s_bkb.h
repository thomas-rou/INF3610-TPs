...
// ==============================================================
#ifndef __HLS_accel_mul_8s_bkb__HH__
#define __HLS_accel_mul_8s_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(HLS_accel_mul_8s_bkb) {
    ...
    SC_CTOR(HLS_accel_mul_8s_bkb):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
