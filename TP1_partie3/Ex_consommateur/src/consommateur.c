...
// Attention ce programme loge à l'adresse 0x2000000 et possede une dimension de 0x1000000
...
#define 		TASK_CONSOMMATEUR_PRIO	  15   				// Priorité de TaskActive
...
//	*ack = 0;
 ...
 while (DEF_TRUE) {
	...
	*req = 0;        								// J'ai fini de consommer
    ...
    while(*ack);									// J'attends que le producteur me dise de passer à une prochaine valeur à consommer
